        ...
        <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
          ...
          <Link href="/" className="flex items-center gap-2">
            <div className="relative w-10 h-10">
              <Image src="/logo.png" alt="Saampark" fill className="object-contain roundded-full" />
            </div>
            <div className="flex flex-col">
              <span className="text-2xl font-bold text-blue-900 leading-none">SAAMPARK</span>
              <span className="text-[10px] tracking-[0.2em] text-orange-500 font-bold">TECHNOLOGY & RESEARCH PVT. LTD.</span>
            </div>
          </Link>
