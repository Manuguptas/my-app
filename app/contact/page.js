...
export default function ContactPage() {
  return (
   ...
   <section className="w-full h-[450px] overflow-hidden border-b border-white/10">
  <iframe
    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d118043.9554300959!2d87.24053746765715!3d22.42436815330882!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a1d4181f629198d%3A0x63346e9270df990b!2sMidnapore%2C%20West%20Bengal!5e0!3m2!1sen!2sin!4v1710131456000!5m2!1sen!2sin"
  ...
  />
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-600 text-sm">Balichok,Mednipur<br />West bangal</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="text-blue-500 mb-4">
